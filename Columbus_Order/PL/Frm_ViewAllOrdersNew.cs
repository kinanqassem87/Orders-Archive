...
{
    public partial class Frm_ViewAllOrdersNew : Form
    {
        ...
        //private void Frm_ViewAllOrdersNew_Load(object sender, EventArgs e)
        //{
        //    // TODO: This line of code loads data into the 'pDC_Columbus_OrderDataSet.SelectOrderViewNew' table. You can move, or remove it, as needed.
        //   // this.selectOrderViewNewTableAdapter.Fill(this.pDC_Columbus_OrderDataSet.SelectOrderViewNew);


        //}

        //private void selectOrderViewNewBindingSource_ListChanged(object sender, ListChangedEventArgs e)
        //{
           
        //}

        private void Frm_ViewAllOrdersNew_Load_1(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'odcNewColumbus_OrderDataSet2.SelectOrderViewNew' table. You can move, or remove it, as needed.
            this.selectOrderViewNewTableAdapter1.Fill(this.odcNewColumbus_OrderDataSet2.SelectOrderViewNew);
            // TODO: This line of code loads data into the 'pdc_Columbus_OrderDataSet2.SelectOrderViewNew' table. You can move, or remove it, as needed.
            //this.selectOrderViewNewTableAdapter.Fill(this.pdc_Columbus_OrderDataSet2.SelectOrderViewNew);

        }

        private void selectOrderViewNewBindingSource_ListChanged_1(object sender, ListChangedEventArgs e)
        {
           
        }

        private void selectOrderViewNewBindingSource1_ListChanged(object sender, ListChangedEventArgs e)
        {
            int x = 0;
            foreach (DataGridViewRow row in dgvOrderView.Rows)
            {
                x += int.Parse(row.Cells[5].Value.ToString());
            }
            // lbTotal.Text = "Number OF pieces: " + x.ToString();
            this.Text = "Number OF pieces: " + x.ToString();
            this.Text = "عرض الطلبيات: " + "عدد القطع الكلي : " + x.ToString();
        }

        private void dgvOrderView_FilterStringChanged(object sender, EventArgs e)
        {
            selectOrderViewNewBindingSource1.Filter = dgvOrderView.FilterString;
        }

        private void dgvOrderView_SortStringChanged(object sender, EventArgs e)
        {
            selectOrderViewNewBindingSource1.Sort = dgvOrderView.SortString;
        }
    }
}
